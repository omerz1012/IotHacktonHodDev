...
import com.app_name.Fragments.PushNotif;
import com.app_name.Fragments.PushNotifaction;
...
public class PushListenerService extends FirebaseMessagingService {
    ...
    public void onNewToken(String token) {
        ...
        PushNotif.getPinpointManager(getApplicationContext()).getNotificationClient().registerDeviceToken(token);
    }
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        final NotificationClient notificationClient = PushNotif.getPinpointManager(getApplicationContext()).getNotificationClient();
